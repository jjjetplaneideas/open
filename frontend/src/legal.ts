...
export const LEGAL_DOCS = {
  tos: {
    ...
    body: `By using Anglerj, you agree to these Terms of Service. Anglerj is a fishing forecast and intelligence tool. The information provided — including fishing scores, species recommendations, tide and swell data, weather, and AI-generated summaries — is informational only.

You may not scrape, reverse engineer, copy, redistribute, or commercially reuse the Anglerj forecasting algorithms, fish almanac, AI reports, score models, or proprietary databases without express written permission.

Anglerj is provided "as is" without warranty of any kind. We may change features, pricing, and content at any time.`,
  },
  privacy: {
    title: "Privacy Policy",
    version: CURRENT_LEGAL.privacy,
    body: `Anglerj collects only the data needed to deliver forecasts: your selected location coordinates, saved spots, catch journal entries, unit preferences, and anonymous app usage analytics.
...
Anglerj is an informational tool only. We do not guarantee:
...
You accept full responsibility for your fishing, boating, navigation, travel, equipment, harvest, and safety decisions, and for compliance with all applicable laws and regulations. Anglerj maps are not navigation systems; use official nautical charts and marine electronics.
